	...
	<form action="livro.php" method="post" enctype="multipart/form-data">
	  ...
	  <div class="row">
		...
		<div class="form-group col-md-3">
		  ...
		  <input type="text" class="form-control" name="isbn" value="123455" placeholder="Ex: 123455" min="123455">
		</div>
		
		<div class="form-group col-md-3">
		  <label for="campo3">Edição</label>
		  <input type="number" class="form-control" name="edicaodolivro" value="1" placeholder="Ex: 2">
		</div>
	  </div>
